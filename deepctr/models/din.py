...
def DIN(dnn_feature_columns, history_feature_list, dnn_use_bn=False,
    ...
    if not hasattr(keys_emb, '_keras_history'):
        print("no keys_emb _keras_history")
    else:
        print("has keys_emb _keras_history")
    ...
    if not hasattr(final_logit, '_keras_history'):
        print("no final_logit _keras_history")
    else:
        print("has final_logit _keras_history")
    output = PredictionLayer(task)(final_logit)
    if not hasattr(output, '_keras_history'):
        print("no _keras_history")
    else:
        print("has _keras_history")
